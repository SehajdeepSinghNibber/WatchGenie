  ...
  return (
    ...
    <div className="hero-bg relative">
        ...
        <header className="max-w-6xl mx-auto flex items-center justify-between p-4 pb-10">
            <img src="/watchGenieLogo.png" alt="WatchGenie logo" className="w-32 md:w-52" />
            <Link to={'/login'} className="text-white bg-sky-500 px-2 py-1 rounded hover:bg-sky-700">
                Log In
            </Link>
        </header>
        ...
        <div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto h-[60vh]'>
            ...
            <form className='flex flex-col md:flex-row gap-4 w-1/2' onSubmit={handleFormSubmit}>
                ...
                />
                <button type='submit' className='bg-sky-500 text-xl lg:text-2xl px-2 lg:px-6 py-1 md:py-2 rounded flex justify-center items-center'>
                    Get Started
        ...
        {/* 2nd section */}
			<div className='py-10 bg-black text-white'>
              ...
              '
							>
								<img src='/favicon.png' alt='image' className='h-10' />
